...
function PlayState:init()
    ...
    self.player.stateMachine = StateMachine {
        ...
        ['walk-lifting'] = function() return PlayerWalkLiftingState(self.player, self.dungeon) end,
        ['idle'] = function() return PlayerIdleState(self.player) end,
        ['idle-lifting'] = function() return PlayerIdleLiftingState(self.player) end,
        ['pot-lifting'] = function() return PlayerLiftingPotState(self.player) end,
